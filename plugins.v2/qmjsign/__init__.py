        ...
        try:
            if config:
                ...
                logger.info(f"配置: enabled={self._enabled}, notify={self._notify}, cron={self._cron}, "
                           f"max_retries={self._max_retries}, retry_interval={self._retry_interval}, "
                           f"history_days={self._history_days}, draw_prestige={self._draw_prestige_enabled}, "
